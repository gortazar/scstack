...
public class Usuario extends BaseEntity {
    ...
    public Usuario(modeloDatos.Usuario api_user) {
        this();
    ...
    public modeloDatos.Usuario toUsuarioAPI() throws ExcepcionUsuario {
        return new modeloDatos.Usuario(uid, nombre, apellidos, email, pass);
    }
