...
public class Proyecto extends BaseEntity {
    ...
    public Proyecto(modeloDatos.Proyecto api_proy) {
        this();
        ...
        for (modeloDatos.repositorios.Repositorio repoAPI : api_proy.getRepositorios()) {
    ...
    public modeloDatos.Proyecto toProyectoAPI() throws ExcepcionProyecto {
        modeloDatos.Proyecto proy_api = new modeloDatos.Proyecto(cn, descripcion, "null", null);
